...
import CeramicSEO from "@/components/CeramicSEO";
  ...
  return (
    <div className="w-full bg-[#0a0a0a]">
      ...
      <section className="relative w-full sm:min-h-[60vh] flex flex-col items-center justify-center overflow-hidden bg-black">
        ...
        >
            <source src="/ceramic/ceramic_coating_home.mp4" type="video/mp4" />
        </video>

        {/* Dark Overlays for Text Legibility */}
        <div className="absolute inset-0 bg-black/20 z-10"></div>
        <div className="absolute bottom-0 inset-x-0 h-30 bg-linear-to-b from-transparent to-black z-10 pointer-events-none"></div>
        ...
        <div className="max-w-5xl min-h-[40vh] lg:min-h-[80vh] relative z-20 flex flex-col items-center text-center px-6 mt-35 md:mt-50 lg:mt-50">
            ...
            */}
            ...
            <div className="flex flex-col sm:flex-row items-center w-full sm:w-auto mt-45 md:bottom-15 md:absolute lg:absolute lg:bottom-20">
            <a 
                href="/services/ceramic/#about"
      ...
      <CeramicPackages />
        ...
        <div id="about" className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-[60%_40%] lg:grid-cols-[65%_35%] items-center scroll-mt-28 md:scroll-mt-32">
            ...
            <div className="flex flex-col w-full text-center md:text-left z-10 order-2 md:order-1">
                ...
                <p className="text-gray-200 text-base md:text-lg leading-[1.6] tracking-[-0.04em] mb-4 font-light">
                    Give your car a true reset with professional ceramic coating in San Diego and La Jolla.
                    A ceramic coating is an ultra-durable layer of protection that bonds to your vehicle’s surface like a
                    liquid glass coating, shielding your paint and clear coat from harsh coastal and urban elements.
                </p>
                <p className="text-gray-200 text-base md:text-lg leading-[1.6] tracking-[-0.04em] mb-10 font-light">
                    Think of it as a sacrificial barrier — it defends against UV rays, ocean air, road grime, brake dust, bird droppings,
                    tree sap, and everyday contaminants while keeping your paint glossier and easier to clean. Thanks to its hydrophobic
                    properties, water and dirt slide off instead of sticking, helping your vehicle stay cleaner for longer.
                </p>
            ...
            <div className="relative w-full h-90 md:h-100 rounded-3xl overflow-hidden order-1 md:order-2 flex items-center justify-center bg-black">
                <video 
                    src="/ceramic/ceramic_vid.mp4" 
                    autoPlay 
                    loop 
                    muted 
                    playsInline 
